...
notes: |
  ...
  v5 (2026-04-22 ~21:00 BRT): Julia revalidou pós-deploy e pediu pra FORÇAR
    ausência do resumo estruturado no escalarHumano. Em v3 só a regra foi
    removida, mas o LLM continuou gerando resumo rico por default natural
    (observado em conv=235 às 23:03 UTC). v5 adiciona regra IMPERATIVA
    proibindo resumo estruturado — campo resumo_conversa deve ser BREVE
